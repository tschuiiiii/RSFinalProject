...
class FuntionGloveOthers:
    ...
    def Simfunction(self):
        file_name = "funtionGloveOthers.pickle"
        ...
        if os.path.exists(path):
            ...
            text = self.data["actors"]+" "+self.data["directors"]+" "+self.data["keyword"]+" "+self.data["genres"]+" "+self.data["title"]
